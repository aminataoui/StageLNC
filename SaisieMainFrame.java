...
public class SaisieMainFrame extends javax.swing.JFrame {
    private DoubleArrayList x1;
    private DoubleArrayList y1;
    private DoubleArrayList x2;
    private DoubleArrayList y2;
    ...
    private ArrayList Y;
    private double l;
    private double pressionP;
    private int nbPoints;
    private double[] distances;
    private DoubleArrayList distancesAL;
    ...
    private boolean etalonnage = false;
...
//        canvasesPane.add(penCanvas);
    ...
    private void initComponents() {
        ...
        jButtonCalibrage = new javax.swing.JButton();
        jButtonLongueurSeg = new javax.swing.JButton();
        jButtonSaisieFront = new javax.swing.JButton();
        jButtonEfface = new javax.swing.JButton();
        jStopSaveButton = new javax.swing.JButton();
        ...
        Item_StopSave = new javax.swing.JMenuItem();
        ...
        jButtonCalibrage.setBackground(new java.awt.Color(245, 245, 241));
        jButtonCalibrage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/abiword.png"))); // NOI18N
        jButtonCalibrage.setToolTipText("Calibrage");
        jButtonCalibrage.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButtonCalibrage.setFocusable(false);
        jButtonCalibrage.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButtonCalibrage.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jButtonCalibrage.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonCalibrageMouseClicked(evt);
            }
        });
        jButtonCalibrage.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCalibrageActionPerformed(evt);
            }
        });
        jToolBar.add(jButtonCalibrage);

        jButtonLongueurSeg.setBackground(new java.awt.Color(245, 245, 241));
        jButtonLongueurSeg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/Information24.gif"))); // NOI18N
        jButtonLongueurSeg.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButtonLongueurSeg.setFocusable(false);
        jButtonLongueurSeg.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButtonLongueurSeg.setMaximumSize(new java.awt.Dimension(38, 38));
        jButtonLongueurSeg.setMinimumSize(new java.awt.Dimension(38, 38));
        jButtonLongueurSeg.setPreferredSize(new java.awt.Dimension(38, 38));
        jButtonLongueurSeg.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jButtonLongueurSeg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonLongueurSegActionPerformed(evt);
            }
        });
        jToolBar.add(jButtonLongueurSeg);
        jButtonLongueurSeg.getAccessibleContext().setAccessibleDescription("Longueur Segment");
        ...
        jStopSaveButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/StopSign.gif"))); // NOI18N
        jStopSaveButton.setToolTipText("Arreter et enregister l'acquisition");
        jStopSaveButton.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jStopSaveButton.setBounds(new java.awt.Rectangle(0, 0, 0, 0));
        jStopSaveButton.setFocusable(false);
        jStopSaveButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jStopSaveButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jStopSaveButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jStopSaveButtonActionPerformed(evt);
            }
        });
        jToolBar.add(jStopSaveButton);
        ...
        Item_Stop.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_ENTER, 0));
        ...
        Item_StopSave.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_ESCAPE, 0));
        Item_StopSave.setFont(new java.awt.Font("Verdana", 1, 10)); // NOI18N
        Item_StopSave.setText("Arrêter+ Enregistrer...");
        Item_StopSave.setToolTipText("Arrêter et enregister l'acquisition du tracé");
        Item_StopSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Item_StopSaveActionPerformed(evt);
            }
        });
        Jmenu_Actions.add(Item_StopSave);
        ...
        Item_Save.setFont(new java.awt.Font("Verdana", 1, 10)); // NOI18N
        Item_Save.setText("Enregistrer");
        Item_Save.setToolTipText("Enregistrer le tracé");
        Item_Save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Item_SaveActionPerformed(evt);
            }
        });
        Jmenu_Actions.add(Item_Save);
...
//        }
  ...
  private void save(){
    ...
    private void jButtonCalibrageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalibrageActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonCalibrageActionPerformed

    private void jButtonCalibrageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCalibrageMouseClicked
        final JFrame frame;
	...
	JLabel label = new JLabel("Veuillez tracer un segment horizontal de 10cm");
        label.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
	panel.add(label);
        JButton boutonX = new JButton("Horizontal");
        panel.add(boutonX);
        JButton boutonY = new JButton("Vertical");
        panel.add(boutonY);
        boutonX.addActionListener(this::jButtonXActionPerformed);
        boutonY.addActionListener(this::jButtonYActionPerformed);
           
    }//GEN-LAST:event_jButtonCalibrageMouseClicked
     private void jButtonXActionPerformed(java.awt.event.ActionEvent evt) {                                                   
       statusEtHistorique(Utils.getDate_TimeNow()[1] + " : tracer un segment horizontal de 10 cm ", true);
       jToggleButton_Start.setSelected(true);
       startStopAction();
     ...
     private void jButtonYActionPerformed(java.awt.event.ActionEvent evt) {                                                   
       statusEtHistorique(Utils.getDate_TimeNow()[1] + " : tracer un segment vertical de 10 cm ", true);
       jToggleButton_Start.setSelected(true);
       startStopAction(); 
       calibration();
    ...
    private void jButtonLongueurSegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLongueurSegActionPerformed
        calibration();
        afficherLongueurSegment();
    }//GEN-LAST:event_jButtonLongueurSegActionPerformed

    private void jStopSaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jStopSaveButtonActionPerformed
        jToggleButton_Start.setSelected(false);
        startStopAction(); //arret de l'enregistrement
        save(); // + enregistrement
    }//GEN-LAST:event_jStopSaveButtonActionPerformed

    private void Item_StopSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Item_StopSaveActionPerformed
        jToggleButton_Start.setSelected(false);
        startStopAction(); //arret de l'enregistrement
        save(); // + enregistrement
    }//GEN-LAST:event_Item_StopSaveActionPerformed
    ...
    public void afficherLongueurSegment (){
        final JFrame frame; // creation d'une fenetre d'affichage 
        frame = new JFrame("Longueur segment");
        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        ...
        frame.add(panel);
	panel.setLayout(new FlowLayout());
	JLabel label = new JLabel("Le segment 1 mesure: " + getL() + units + "\n" + "le segment 2 mesure: " + getL2() + units );
        label.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
        
	panel.add(label);
        
        if(getL() >= 99.00 && getL() <= 101.00 && getL2() >= 99.00 && getL2() <= 101.00){ // si la longueur tracé correspond à la longueur réelle
            JLabel label2 = new JLabel("Vous pouvez commencer l'acquisition !");
            label2.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
            label2.setForeground(java.awt.Color.blue);
            panel.add(label2);
            
        }else{ // sinon on applique un coefficient
            JLabel label2 = new JLabel(" Attention: Le segment ne fait pas 10 cm !");
            label2.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
            label2.setForeground(java.awt.Color.red);
            panel.add(label2); 
            JLabel label3 = new JLabel("Veuillez retracer un trait de 10cm ");
            label3.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
            label3.setForeground(java.awt.Color.red);
            panel.add(label3); 
            JLabel label4 = new JLabel("ou appliquer un coefficent X de " + coefX + " et un coefficient Y de " + coefY+ " sur vos données.");
            label4.setFont(new java.awt.Font(Font.SANS_SERIF,Font.PLAIN,15));
    ...
    private void calibration(){
        ArrayList<SampleDoubleZ> sampleArray = getSamplesList();
        X = new ArrayList();
        Y = new ArrayList();
        if(sampleArray.isEmpty()){
            statusEtHistorique("Demande enregistrement : pas de données !", true);    
            return;    
        }
        //recup x et y
        for (int i = 0; i < sampleArray.size(); i++) {
            SampleDoubleZ Sample = sampleArray.get(i);
           
            if (Sample.getP()> 0){ // pression > 0 (correspond a une trace)
                
                pressionP = Sample.getP();
                X.add(Sample.getX()); //on recupere les X
                Y.add(Sample.getY()); //on recupere les Y
       ...
       // recupperation des min et des max X et Y
        X1= (double) Collections.min(X);
        
        X2= (double) Collections.max(X);
        
        Y1= (double) Collections.min(Y);
        
        Y2= (double) Collections.max(Y);
        
        // calcul la longueur du segment horizontal
       setL(sqrt((Y2 -Y1)*(Y2 -Y1) + (X2 - X1)*(X2 - X1))); //theoreme de pythagore
       coefX = l/100;
       
       // calcul la longueur du segment vertical
       setL2(sqrt((Y2 -Y1)*(Y2 -Y1) + (X2 - X1)*(X2 - X1))); //theoreme de pythagore
       coefY = l2/100;
    ...
    private javax.swing.JMenuItem Item_StopSave;
    ...
    private javax.swing.JButton jButtonCalibrage;
    private javax.swing.JButton jButtonEfface;
    private javax.swing.JButton jButtonJsonSave;
    private javax.swing.JButton jButtonLongueurSeg;
    ...
    private javax.swing.JButton jStopSaveButton;
    ...
    /**
     * @return the etalonnage
     */
    public boolean isEtalonnage() { 
        return etalonnage;
    }

    /**
     * @param etalonnage the etalonnage to set
     */
    public void setEtalonnage(boolean etalonnage) {
        this.etalonnage = etalonnage;
    }

    /**
     * @return the longueur l 
     */
    public double getL() { 
        return l;
    }
    ...
    /**
     * @param l2 the longueur l2 to set
     */
